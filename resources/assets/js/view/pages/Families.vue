<template>
    <div class="d-flex flex-column-fluid">
        ...
        <div class="container">
            ...
            <div class="row">
                <!--begin::Col-->
                <div v-for="user in parents" class="col-xl-4 col-lg-6 col-md-6 col-sm-6">
                    <!--begin::Card-->
                    <div class="card card-custom gutter-b card-stretch">
                        ...
                        <div class="card-body pt-4">
                            ...
                            <div class="mt-9 text-center">
                                <router-link :to="{name:'show-family',params:{id:user.id}}" class="btn btn-md btn-icon btn-light-success btn-pill mx-2">
