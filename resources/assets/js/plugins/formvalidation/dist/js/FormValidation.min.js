(function (global, factory) {
    typeof exports === "object" && typeof module !== "undefined" ? factory(exports) : typeof define === "function" && define.amd ? define(["exports"], factory) : (global = global || self, factory(global.FormValidation = {}))
        ...
        _createClass(l, [{
            ...
            key: "validateElement", value: function validateElement(e, t) {
                ...
                return this.waterfall(r).then((function (s) {
                    ...
                    _this3.emit("core.element.validated", {element: t, elements: i, field: e, valid: l});
            ...
            key: "getElementValue", value: function getElementValue(e$1, t, s) {
    ...
    var t$e = function () {
        ...
        _createClass(t, [{
            key: "setCore", value: function setCore(t) {
                this.core = t;
                return this
            }
        }, {
    ...
    var e$6 = function (_t) {
        ...
        _createClass(e, [{
            ...
            key: "getValidatorName", value: function getValidatorName(t, e) {
    ...
    var t$f = function (_e) {
        ...
        _createClass(t, [{
            ...
            key: "createPluginInstance", value: function createPluginInstance(e, t) {
                var s = e.split(".");
                var a = window || this;
    ...
    var e$8 = function (_t) {
        ...
        _createClass(e, [{
            ...
            key: "ignoreValidation", value: function ignoreValidation(t, e, i) {
                return this.opts.excluded.apply(this, [t, e, i])
            }
        }], [{
            key: "defaultIgnore", value: function defaultIgnore(t, e, i) {
    ...
    var s$5 = function (_e) {
        ...
        _createClass(s, [{
            ...
            key: "prepareElementContainer", value: function prepareElementContainer(e, s, i) {
                var a;
                switch (true) {
                ...
                this.core.emit("plugins.message.placed", {element: s, elements: i, field: e, messageElement: l});
            ...
            key: "getClosestContainer", value: function getClosestContainer(e, t, s) {
                var i = e;
                while (i) {
                    if (i === t) {
                        break
    ...
    var i$1 = function (_e) {
        ...
        _createClass(i, [{
            ...
            key: "prepareElementIcon", value: function prepareElementIcon(e, i) {
                ...
                var l = {
                    ...
                    }, element: i, field: e, iconElement: n
                };
            ...
            key: "onElementValidating", value: function onElementValidating(e) {
                ...
                var i = {element: e.element, field: e.field, iconElement: t, status: "Validating"};
            ...
            key: "onElementValidated", value: function onElementValidated(e) {
                ...
                var i = {element: e.element, field: e.field, iconElement: t, status: e.valid ? "Valid" : "Invalid"};
                this.core.emit("plugins.icon.set", i);
                this.opts.onSet(i)
            }
        }, {
            key: "onElementNotValidated", value: function onElementNotValidated(e) {
                ...
                var i = {element: e.element, field: e.field, iconElement: t, status: "NotValidated"};
                this.core.emit("plugins.icon.set", i);
                this.opts.onSet(i)
            }
        }, {
            key: "onElementIgnored", value: function onElementIgnored(e) {
                ...
                var i = {element: e.element, field: e.field, iconElement: t, status: "Ignored"};
                this.core.emit("plugins.icon.set", i);
                this.opts.onSet(i)
            }
        }, {
            key: "setClasses", value: function setClasses(e, i, n, l) {
    ...
    var i$2 = function (_e) {
        ...
        _createClass(i, [{
            ...
            key: "shouldValidate", value: function shouldValidate(e, i, t, l) {
    ...
    var i$3 = function (_t) {
        ...
        _createClass(i, [{
            ...
            key: "show", value: function show(t, i) {
                i.preventDefault();
                i.stopPropagation();
    ...
    var t$i = function (_e) {
        ...
        _createClass(t, [{
            ...
            key: "prepareHandler", value: function prepareHandler(e, t) {
                var _this2 = this;
                t.forEach((function (t) {
                    var i = [];
                    switch (true) {
                    ...
                    i.forEach((function (i) {
                        ...
                        _this2.handlers.push({element: t, event: i, field: e, handler: s});
                        t.addEventListener(i, s)
                    }))
                }))
            }
        }, {
            key: "handleEvent", value: function handleEvent(e, t, i) {
                var _this3 = this;
                if (this.exceedThreshold(t, i) && this.core.executeFilter("plugins-trigger-should-validate", true, [t, i])) {
                    var s = function s() {
                        return _this3.core.validateElement(t, i).then((function (s) {
                            _this3.core.emit("plugins.trigger.executed", {element: i, event: e, field: t})
                        }))
                    };
            ...
            key: "exceedThreshold", value: function exceedThreshold(e, t) {
    ...
    var index$3 = {call: t$6, classSet: c, closest: t$h, fetch: e$4, format: r, hasClass: s$6, isValidDate: t$9};
    var p = {};
    exports.Plugin = t$e;
